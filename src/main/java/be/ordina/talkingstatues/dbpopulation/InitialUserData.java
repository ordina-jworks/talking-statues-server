...
public class InitialUserData {
    ...
    public static final AppUser[] DATA = new AppUser[]{
            ...
            new AppUser("newUser5", "Jay", "cslemlk"),
            new AppUser("newUser6", "Patrick", "selkdjdeizj"),
            new AppUser("newUser7", "Willem", "ozdiejdiej"),
            new AppUser("newUser8", "Anton", "cdpoziepd"),
            new AppUser("newUser9", "Adriaan", "lzqdjlijqd"),
